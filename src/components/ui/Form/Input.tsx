  ...
  <T extends ElementType = "input">(props: any, ref: ForwardedRef<any>) => {
    ...
    const affixClass = clsx(
      ...
      error
        ...
        : "peer-focus:text-[#071952] dark:text-dark-300 dark:peer-focus:text-[#071952] text-gray-400",
    );
              ...
              !unstyled && [
                ...
                error
                  ...
                  : disabled
                    ...
                    : // ✅ Updated primary color here
                    "peer focus:border-[#071952] hover:border-[#071952] dark:border-dark-450 dark:hover:border-[#071952] dark:focus:border-[#071952] border-gray-300",
              ],
              className,
              classNames.input,
            )}
