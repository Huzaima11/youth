...
// Neutral color (gray) styles
const neutralVariants: Record<Variant, string> = {
  filled:
    "bg-[#071952] rounded-sm text-white text-sm py-3 active:bg-[#071952]/80 dark:bg-surface-2 dark:text-dark-50 dark:hover:bg-surface-1 dark:focus:bg-surface-1 dark:active:bg-surface-1/90",
...
const ButtonInner = forwardRef(
  <E extends ElementType = "button">(
    ...
    // Apply primary color (#071952)
    const primaryColor =
      color === "primary"
        ? {
          filled:
            "bg-[#071952] text-white hover:bg-[#0a2a74] active:bg-[#0a2a74]/90 focus:ring-2 focus:ring-[#071952]/30",
          soft: "bg-[#071952]/10 text-[#071952] hover:bg-[#071952]/20",
          outlined:
            "border border-[#071952] text-[#071952] hover:bg-[#071952]/10",
          flat: "text-[#071952] hover:bg-[#071952]/10",
        }[variant]
        : null;
